...
| Q2 | Illustrative canonical/adversarial behavior on three synthetic states in two weight modes | A representative mean EPIC/serial gap on model states | Replay the ADR 0020 amended sample of 24 saved states from two tasks, three seeds, and four denoising steps through the same three selectors |
